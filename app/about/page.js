      ...
      <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] h-full w-full items-center px-5 py-24">
        <div className="mx-auto text-center text-white container p-0 my-9 py-9 space-y-5 w-3/4 font-body">
          ...
          <h1 className="text-3xl py-5">
            SymbiSwap is made by a group of students from Symbiosis Institute of
            Technology. It is a unique barter-based marketplace for SIT students
            to exchange skills, notes, and assignments—no money involved! Post
            gigs, collaborate with peers, earn ratings, and unlock achievement
            badges while building a strong academic network. Swap skills and
            build bonds! 🚀
          </h1>
          <Link href="/">
