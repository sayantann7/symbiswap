    ...
    <nav className="bg-white border-gray-200 dark:bg-black dark:border-gray-700 shadow-lg dark:shadow-xl">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <Link href="/profile">
          <div className="relative inline-flex items-center justify-center mt-0 w-11 h-11 overflow-hidden bg-gray-50 rounded-full dark:bg-gray-500 rounded-full ring-2 ring-purple-700 dark:ring-purple-600">
